...
from dqk.scoring.scorer import QualityReport, QualityScore, available_checks, run_all_checks
...
class TestBugRegressions:
    def test_check_issue_column_field_not_cloumn(self):
    ...
    def test_check_issue_extra_is_dict_not_list(self):
    ...
    def test_add_issue_preserves_column(self):
...
class TestCompletenessCheck:
    def test_perfect_data_scores_one(self):
    ...
    def test_high_null_rate_triggers_fail(self):
    ...
    def test_moderate_null_rate_triggers_warn(self):
    ...
    def test_metrics_include_null_rates(self):
...
class TestValidityCheck:
    def test_clean_numeric_passes(self):
        df = pd.DataFrame({"age": [25, 30, 45]})
        result = ValidityCheck().run(make_ds(df))
        assert result.severity == CheckSeverity.PASS

    def test_range_guard_catches_violations(self):
    ...
    def test_regex_guard_catches_invalid_emails(self):
...
class TestUniquenessCheck:
    ...
    def test_key_column_duplicate_caught(self):
...
class TestDistributionCheck:
    ...
    def test_heavy_skew_raises_issue(self):
    ...
    def test_many_outliers_raises_fail(self):
        base = list(range(90))
    ...
    def test_rare_category_detected(self):
...
class TestTextQualityCheck:
    ...
    def test_allcaps_noise_detected(self):
    ...
    def test_metrics_have_length_stats(self):
...
class TestLabelQualityCheck:
    def test_no_label_cols_skips(self):
        df = pd.DataFrame({"x": [1, 2, 3]})
        result = LabelQualityCheck().run(make_ds(df))
        assert result.severity == CheckSeverity.SKIP

    def test_balanced_labels_pass(self):
    ...
    def test_rare_class_warned(self):
    ...
    def test_metrics_include_class_distribution(self):
...
class TestScoring:
    ...
    def test_available_checks_lists_all_six(self):
        checks = available_checks()
        expected = {"completeness", "validity", "uniqueness", "distribution", "text_quality", "label_quality"}
        assert expected.issubset(set(checks))

    def test_run_subset_of_checks(self):
    ...
    def test_skipped_checks_not_penalized(self):
...
class TestDriftDetection:
    def test_identical_datasets_no_drift(self):
    ...
    def test_drift_report_has_column_results(self):
